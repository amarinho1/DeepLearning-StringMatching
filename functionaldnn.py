...
from keras.layers import Reshape, Flatten, Masking, Dense, Input, Dropout, GRU, Bidirectional, GlobalMaxPooling1D, Layer, Masking, Lambda, Permute, Highway, TimeDistributed
...
def deep_neural_net_gru(train_data_1, train_data_2, train_labels, test_data_1, test_data_2, test_labels, max_len,
    ...
    gru1 = GRU(hidden_units, implementation=2, return_sequences=True, name='gru1' )
    gru2 = GRU(hidden_units, implementation=2, return_sequences=( alignment or selfattention or maxpooling), name='gru2') 
